...
model {
  ...
  for (r in 1:S){
    // print("station ",r);
    tmp2 = gev_v_log_v_2cov_SgST(col(y,r), covar1[,r], covar2[,r], alpha_loc0[r], alpha_loc1[r], alpha_loc2[r], Log_scale0[r], shape[r]);
    tmp3 = gev_v_cdf_v_2cov_SgST(col(y,r), covar1[,r], covar2[,r], alpha_loc0[r], alpha_loc1[r], alpha_loc2[r], Log_scale0[r], shape[r]);
    for (i in 1:N){
      lp[i,r] = tmp2[i];
      Fs[i,r] = tmp3[i]; 
    }
